...
import {StyleSheet, Text, View, TouchableWithoutFeedback, Modal, TextInput, FlatList, Keyboard, TouchableOpacity} from 'react-native'
        ...
        <View style = {{alignItems:'center'}}>
            <TouchableWithoutFeedback
                ...
                <View style = {styles.SearchArea}>
                    ...
                    size = {32}
                        />
                    <Text style ={{fontSize:15}}>무엇을 찾으십니까?</Text>
                </View>
            </TouchableWithoutFeedback>
